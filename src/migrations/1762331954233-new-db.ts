...
export class NewDb1762331954233 implements MigrationInterface {
  name = 'NewDb1762331954233';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "order" ("idOrder" uuid NOT NULL DEFAULT uuid_generate_v4(), "totalAmount" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "status" character varying NOT NULL, "idUser" uuid, CONSTRAINT "PK_5d1d58179295378ca899728c3ec" PRIMARY KEY ("idOrder"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "cart_item" ("idCartItem" uuid NOT NULL DEFAULT uuid_generate_v4(), "quantity" integer NOT NULL, "idProduct" uuid, "idUser" uuid, CONSTRAINT "PK_4971f8fea489e5b3ef5ba598c94" PRIMARY KEY ("idCartItem"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "cart_item" ADD CONSTRAINT "FK_b9d4703574b817aa17129d1a031" FOREIGN KEY ("idProduct") REFERENCES "product"("idProduct") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "cart_item" ADD CONSTRAINT "FK_e868210ec256ce8a2a5a2c3855d" FOREIGN KEY ("idUser") REFERENCES "user"("idUser") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "cart_item" DROP CONSTRAINT "FK_e868210ec256ce8a2a5a2c3855d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "cart_item" DROP CONSTRAINT "FK_b9d4703574b817aa17129d1a031"`,
    );
    await queryRunner.query(
